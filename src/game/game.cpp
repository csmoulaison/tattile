...
void game_update(Game* game, Windowing::Context* window, Render::State* render_state)
{
	...
	Render::text(render_state, "Faust", 32.0f, window->window_height - 96.0f, 1.0f, 0.8, 0.8f, 0.8f, sin((float)game->frames_since_init * 0.01f));
	Render::text(render_state, "After years of wandering the forest, Faust comes upon a crossroads.", 32.0f, window->window_height - 164.0f, 0.5f, 0.8f, 0.8f, 0.8f, 1.0f);
}
